!function (e, n, r) {
    ...
    n.directive("angularFilemanager", ["$parse", "fileManagerConfig", function (e, n) {
        return {restrict: "EA", templateUrl: n.tplPath + "/main.html"}
    ...
    e.module("FileManagerApp").controller("FileManagerCtrl", ["$scope", "$rootScope", "$window", "$translate", "fileManagerConfig", "item", "fileNavigator", "apiMiddleware", function (e, r, i, a, t, o, s, l) {
        ...
        e.config = t, e.reverse = !1, e.predicate = ["model.type", "model.name"], e.order = function (n) {
            ...
            if (!(!n || a && e.isSelected(n))) {
                if (r && r.shiftKey && !a) {
                    var t = e.fileList, o = t.indexOf(n), s = e.temps[0], l = t.indexOf(s), d = void 0;
                    if (s && t.indexOf(s) < o) {
            ...
            var r = e.singleSelection(), i = {url: e.apiMiddleware.getUrl(r), filename: r.model.name},
            ...
            var n = e.singleSelection();
            if (n) {
                var i = n.tempModel.name.trim(), t = e.fileNavigator.fileNameExists(i);
            ...
            var n = e.temp.tempModel.name.trim(), i = e.fileNavigator.fileNameExists(n);
            ...
            var n = e.temp, i = e.temp.tempModel.name.trim(), t = e.fileNavigator.fileNameExists(i);
            ...
            var n = e.singleSelection(), r = n.tempModel.name, i = n.tempModel.path.join("") === n.model.path.join("");
        ...
        var c = function (e) {
            var n = r.selectedModalPath.join(""), i = e && e.model.path.join("");
            return i === n
        }, p = function (e) {
    ...
    e.module("FileManagerApp").controller("ModalFileManagerCtrl", ["$scope", "$rootScope", "fileNavigator", function (e, n, r) {
        e.reverse = !1, e.predicate = ["model.type", "model.name"], e.fileNavigator = new r, n.selectedModalPath = [], e.order = function (n) {
            ...
            var r = n.selectedModalPath.filter(Boolean), i = "/" + r.join("/");
    ...
    e.module("FileManagerApp").service("chmod", function () {
        ...
        return e.prototype.toOctal = function (e, n) {
            ...
            if (e = ("" + e).replace(/\s/g, ""), e = 10 === e.length ? e.substr(1) : e, /^[-rwxts]{9}$/.test(e)) {
                ...
                return {owner: n[0], group: n[1], others: n[2]}
            }
    ...
    e.module("FileManagerApp").service("apiHandler", ["$http", "$q", "$window", "$translate", "Upload", function (e, r, i, a, t) {
        ...
        return o.prototype.deferredHandler = function (e, n, r, i) {
            ...
            var t = this, o = a || t.deferredHandler, s = r.defer(), l = {action: "list", path: i};
            ...
            var s = this, l = r.defer(), d = {action: "copy", items: i, newPath: t};
            ...
            var o = this, s = r.defer(), l = {action: "move", items: i, newPath: t};
            ...
            var t = this, o = r.defer(), s = {action: "remove", items: i};
            ...
            var t = this, o = r.defer(), s = {action: "getContent", item: i};
            return t.inprocess = !0, t.error = "", e.post(n, s).success(function (e, n) {
                t.deferredHandler(e, o, n)
            }).error(function (e, n) {
            ...
            var o = this, s = r.defer(), l = {action: "edit", item: i, content: t};
            return o.inprocess = !0, o.error = "", e.post(n, l).success(function (e, n) {
                o.deferredHandler(e, s, n)
            }).error(function (e, n) {
            ...
            var o = this, s = r.defer(), l = {action: "rename", item: i, newItemPath: t};
            return o.inprocess = !0, o.error = "", e.post(n, l).success(function (e, n) {
                o.deferredHandler(e, s, n)
            }).error(function (e, n) {
            ...
            var c = this, p = r.defer(), m = {action: "downloadMultiple", items: o, toFilename: s},
                u = [t, n.param(m)].join("?");
            ...
            var s = this, l = r.defer(), d = {action: "compress", items: i, destination: o, compressedFilename: t};
            ...
            var s = this, l = r.defer(), d = {action: "extract", item: i, destination: o, folderName: t};
            return s.inprocess = !0, s.error = "", e.post(n, d).success(function (e, n) {
                s.deferredHandler(e, l, n)
            }).error(function (e, n) {
            ...
            var t = this, o = r.defer(), s = {action: "createFolder", newPath: i};
            return t.inprocess = !0, t.error = "", e.post(n, s).success(function (e, n) {
                t.deferredHandler(e, o, n)
            }).error(function (e, n) {
    ...
    e.module("FileManagerApp").service("apiMiddleware", ["$window", "fileManagerConfig", "apiHandler", function (e, n, r) {
        ...
        return i.prototype.getPath = function (e) {
            ...
            var i = this.getFileList(e), a = r.tempModel.perms.toCode(), t = r.tempModel.perms.toOctal(),
